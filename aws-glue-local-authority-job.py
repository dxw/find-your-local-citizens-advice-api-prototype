...
S3bucket_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="csv",
    connection_options={
        "paths": ["s3://caew-find-lca-test/local-authorities/raw/"],
        "recurse": True,
    },
...
ApplyMapping_node2 = ApplyMapping.apply(
    ...
    mappings=[
        ("Id", "string", "local_authority_foreign_key", "string"),
...
S3bucket_node3 = glueContext.getSink(
    path="s3://caew-find-lca-test/local-authorities/csv/versions/",
    connection_type="s3",
...
S3bucket_node3.setCatalogInfo(
    catalogDatabase="salesforce_data", catalogTableName="local_authorities"
)
...
df.write.mode('overwrite').csv('s3://caew-find-lca-test/local-authorities/csv/', header=True, quoteAll=True, escape="\\")
...
source = "local-authorities/csv/"
target = "local-authorities/csv/renamed"
